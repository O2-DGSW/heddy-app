...
export const FloatingActionButton = ({ onClick, label, children }: FloatingActionButtonProps) => {
  return (
    <button
      ...
      onClick={onClick}
      aria-label={label}
      className="fixed bottom-[calc(100px+var(--safe-area-inset-bottom,env(safe-area-inset-bottom,0px)))] right-4 flex h-14 w-14 items-center justify-center rounded-full border-0 shadow-[0_4px_12px_rgba(0,0,0,0.15)]"
