...
export const CutsAnalysisConfidenceCard = ({ percent, description }: CutsAnalysisConfidenceCardProps) => {
  return (
    <div
      className="mx-4 mt-4 flex items-center justify-between gap-3 rounded-2xl p-4"
      style={{ backgroundColor: lightTheme.background.normal, boxShadow: "0 0 6px rgba(0,0,0,0.07)" }}
    >
