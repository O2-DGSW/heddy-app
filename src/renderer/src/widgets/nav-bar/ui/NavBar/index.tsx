...
const NavBar = () => {
  ...
  return (
    ...
    <nav
      aria-label="하단 메뉴"
      className="flex w-full items-start justify-center gap-[clamp(34px,10.95vw,44px)] rounded-tl-[20px] rounded-tr-[20px] pb-[max(16px,var(--safe-area-inset-bottom,env(safe-area-inset-bottom,0px)))] pt-[16px] shadow-[0_-2px_6px_rgba(0,0,0,0.05)]"
